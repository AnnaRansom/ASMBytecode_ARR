// This is the same code as gen4.java except it's titled gen6 and creates a file called program6.java
...
public class gen6 {
    public static void main(String[] args) throws IOException {
        ...
        try (FileOutputStream fos = new FileOutputStream("program6.class")) {
            fos.write(bytes);
        }
    }
}
